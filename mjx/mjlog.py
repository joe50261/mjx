...
A self-contained, standard-library-only reader for Tenhou's ``mjlog`` XML format.
The companion :class:`mjx.agents.MjlogReplayAgent` replays a parsed game through
:class:`mjx.MjxEnv`.
